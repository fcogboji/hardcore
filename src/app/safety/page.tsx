...
export default function HealthAndSafetyPage() {
  return (
    <main className="px-4 py-8 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      <nav className="mb-6 flex flex-wrap gap-2 text-blue-600 font-medium text-sm sm:text-base">
        <Link href="/">Home</Link>
      ...
      >
        {/* You can add alt text or overlays here if needed */}
      </section>
      ...
      <section className="mb-8">
        <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">Key Contacts</h3>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-4 sm:pl-6 text-gray-600 space-y-1 text-sm sm:text-base">
